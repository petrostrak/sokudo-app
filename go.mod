module github.com/petrostrak/sokudo-bare

go 1.18

require (
	github.com/go-chi/chi/v5 v5.0.7
	github.com/petrostrak/sokudo v0.0.0-20220523143650-65458710b0b6
	github.com/petrostrak/sokudo-helper v0.0.0-20220523133551-6b0e4acf888a
